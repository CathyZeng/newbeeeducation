...
public class OrderController {
    ...
    @GetMapping("/mycourse/inprogress")
    public String courseInprogress(@RequestParam Map<String, Object> params, HttpServletRequest request, HttpSession httpSession) {
        request.setAttribute("path", "orders");
        return "mall/courseInprogress";
    }
    ...
    public String courseCompleted(@RequestParam Map<String, Object> params, HttpServletRequest request, HttpSession httpSession) {
        request.setAttribute("path", "orders");
        return "mall/courseCompleted";
    }
